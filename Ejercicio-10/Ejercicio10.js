...
class Electricidad{
    ...
    constructor(initFecha, endFecha, lan, categoria, widget, hsDay){                                                              
        ...
        this.ccaa = "geo_limit=" + "peninsular"; //alcance = ccaa o bien peninsular
...
class RequestCreator{
    ...
    pedirElectricista(initFecha, endFecha, lan, categoria, widget,hasDay){

        return new Electricidad(initFecha, endFecha, lan, categoria, widget,hasDay);
    ...
    iniciarRequest(){
       ...
       let categoriaStr =  this.comprobarCampos();
       ...
       if(checkbox.checked){
        ...
        let electricista = this.pedirElectricista($("#selecFechaInit").val() , $("#selecFechaFin").val(), "es", categoriaStr, $("select option:selected").val(),hasDay);
